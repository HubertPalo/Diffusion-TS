...
class MultiModalHARSeriesDataModule(L.LightningDataModule):
    def __init__(
        ...
        channels_before_timestamps: bool = True
    ):
        """Define the dataloaders for train, validation and test splits for
        ...
        self.channels_before_timestamps = channels_before_timestamps
    ...
    def _load_dataset(
        ...
        for i, data in enumerate(self.data_path):
            ...
            dataset = MultiModalSeriesCSVDataset(
                ...
                channels_before_timestamps=self.channels_before_timestamps,
            )
    ...
    def setup(self, stage: str):
        ...
        if stage == "fit":
            ...
            if self.use_train_as_validation:
                ...
                self.datasets["validation"] = self._load_dataset(
                    "validation"
                )
